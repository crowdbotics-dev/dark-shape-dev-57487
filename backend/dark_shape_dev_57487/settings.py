"""
Django settings for dark_shape_dev_57487 project.
...
ROOT_URLCONF = 'dark_shape_dev_57487.urls'
...
WSGI_APPLICATION = 'dark_shape_dev_57487.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_shape_dev_57487 API",
    "DESCRIPTION": "API documentation for dark_shape_dev_57487 App",
    "VERSION": "v1",
}
